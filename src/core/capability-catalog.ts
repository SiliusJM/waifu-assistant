...
export const CAPABILITY_CATALOG: readonly CapabilityCatalogEntry[] = [
  {
    ...
    helpLines: [
      ...
      '/pending [id]        Revisa acciones locales pendientes; no las ejecuta',
      '/confirm-action <id> Confirma una acción sin ejecutarla',
      '/defer-action <id>   Pospone una acción pendiente',
      '/discard-action <id> Descarta una acción no ejecutada',
      '/duplex              Activa turnos de voz automáticos con VAD',
      '/duplex-stop         Detiene el modo duplex',
    ...
    naturalHelp: 'Puedes conversar en varios turnos. Escribe una nueva entrada para interrumpir una respuesta activa, usa /cancel para detenerla o /exit para terminar. La voz automática usa /duplex y /duplex-stop; /listen y /listen-stop mantienen push-to-talk. Cambia el estilo con /tone [nombre] y la estructura con /format [nombre].',
  },
  {
    id: 'memory',
