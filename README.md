...
- `docs/phase-08-real-browser-dns-rebinding-netlog-execution-2026-09-22.md`: evidencia browser real de resolución, endpoint TCP y timeout mediante NetLog.
...
La siguiente etapa no es implementación productiva ni una Phase 9 definida. El milestone actual es la disposición del `decision-gate` de ADR-012: conservar la evidencia browser NetLog como `REAL / OBSERVED + LIMITATION`, decidir si se requiere una ejecución futura de los artefactos formales faltantes y mantener bloqueada la selección de arquitectura y providers hasta contar con evidencia suficiente. Las VMs permanecen apagadas.
